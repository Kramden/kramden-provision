...
class SpecManualTest(Adw.Bin):
    def __init__(self):
        ...
        # Create window title for required list boxes
        required_windowtitle = Adw.WindowTitle()
        required_windowtitle.set_title("Kramden Spec")
        ...
        required_list_box.append(wifi_row)
        required_list_box.append(webcam_row)
        required_list_box.append(keyboard_row)
        required_list_box.append(touchpad_row)
        required_list_box.append(screentest_row)
    ...
    def on_screentest_toggled(self, button):
        print("SpecManualTest:on_screentest_toggled")
    ...
    def on_keyboard_toggled(self, button):
        print("SpecManualTest:on_keyboard_toggled")
    ...
    def on_webcam_toggled(self, button):
        print("SpecManualTest:on_webcam_toggled")
    ...
    def on_usb_toggled(self, button):
        print("SpecManualTest:on_usb_toggled")
    ...
    def on_touchpad_toggled(self, button):
        print("SpecManualTest:on_touchpad_toggled")
    ...
    def on_wifi_toggled(self, button):
        print("SpecManualTest:on_wifi_toggled")
    ...
    def on_browser_toggled(self, button):
        print("SpecManualTest:on_browser_toggled")
    ...
    def check_status(self):
        print("SpecManualTest:check_status")
        state = self.state.get_value()
        state['SpecManualTest'] = all(self.required_tests.values())
        print("manualtest:check_status State:" + str(state))

    # on_shown is called when the page is shown in the stack
    def on_shown(self):
        print("SpecManualTest:on_shown")
        self.check_status()
