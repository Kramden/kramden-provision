...
then
    echo "Checking for Lenovo Asset Tags"
fi
...
# Check for presence of physical disks
echo "Checkng for Hard Drives"
disks=$(lsblk -d -o NAME,SIZE,TYPE,RM | awk '{if (($4 != "1") && ($2 != "0B") && ($3 == "disk")) print}')
if [[ ${#disks} > 0 ]];
then
    echo "Disks found"
    echo $disks
